...
const it = {
  ...
  login: {
    ...
    title: 'Bentornato',
    description: 'Accedi al tuo account e riprendi da dove hai lasciato.',
    emailLabel: 'Email',
    passwordLabel: 'Password',
    forgotPassword: 'Password dimenticata?',
    submit: 'Accedi',
    or: 'Oppure',
    googleSubmit: 'Accedi con Google',
  ...
  signup: {
    ...
    description: "Inizia oggi la tua prova gratuita e sfrutta subito l'AI sui tuoi PDF.",
    ...
    errorPasswordTooShort: 'La password deve essere almeno 6 caratteri',
    errorTermsRequired: 'Devi accettare i termini e condizioni',
    agreePrefix: 'Accetto i',
    agreeTerms: 'termini e condizioni',
    submit: 'Registrati',
    or: 'Oppure',
    googleSubmit: 'Registrati con Google',
